var portfolio = {
  "webgis_cuaca": {
    "title": "WebGIS Jakarta Weather Forecast",
    "photo": "webgis_cuaca",
    "project_link": "https://irham24.github.io/mapcuaca/",
    "tags": "leaflet javascript python geopandas Personal_Project",
    "desc":  "This project is an old project that has been made since 2020. But because there is an API update from BMKG (Meteorology, Climatology, and Geophysical Agency) in 2024, this year I updated this map so that it can use the new BMKG API format. One of the differences is that the weather data is obtained using the administrative area code level 4 or subdistrict from the data of the Ministry of Home Affairs (<a href='https://kodewilayah.id'>link</a>). So it is necessary to create point data from each area code. point coordinate data is obtained using geolocation from geopy written on this <a href='https://colab.research.google.com/drive/1vAXPh7fKI4CLHG1_R9iUo_STXCXvlQxz?usp=sharing'>link</a>."
  },
  "gee_carbon_analysis": {
    ...
    "tags": "googleearthengine javascript Personal_Project",
  ...
  "geopandas_2": {
    ...
    "tags": "geopandas python GIS Personal_Project",
  ...
  "petatua": {
    ...
    "tags": "javascript leaflet GIS Personal_Project",
  ...
  "digital_twin": {
    ...
    "tags": "vuejs javascript unreale sql Work_Project",
  ...
  "dki_mapping": {
    ...
    "photo": "dki_mapping",
    "tags": "Photogrametry agisoft Work_Project",
  ...
  "potensi": {
    ...
    "tags": "python javascript GIS leaflet carto Personal_Project",
  ...
  "smf": {
    ...
    "photo": "palembang-smf",
    "tags": "Photogrametry Agriculture agisoft Work_Project",
  ...
  "portofolio": {
    ...
    "tags": "javascript Personal_Project",
