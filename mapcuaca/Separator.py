...
for i in range(int(len(array)/2)):
    if(len(array[2 * i]) == 2):
        prov[array[2 * i]] = {}
        prov[array[2 * i]]["nama"] = array[2 * i + 1]
    elif(len(array[2 * i]) == 5):
        kota[array[2 * i]] = {}
        kota[array[2 * i]]["nama"] = array[2 * i + 1]
    elif(len(array[2 * i]) == 8):
        kec[array[2 * i]] = {}
        kec[array[2 * i]]["nama"] = array[2 * i + 1]
    else:
        kel[array[2 * i]] = {}
        kel[array[2 * i]]["nama"] = array[2 * i + 1]
print(prov)
print(kota)
print(kec)
print(kel)
